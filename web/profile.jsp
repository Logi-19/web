...
<body class="bg-[#f0f7fa] text-[#1e3c5c] antialiased" x-data="profileManager()" x-init="init()" x-cloak>
    ...
    <main class="pt-24 pb-16 px-4 md:px-6 lg:px-8">
        ...
        <div x-show="loading" class="fixed inset-0 bg-white/80 backdrop-blur-sm z-50 flex items-center justify-center">
            <div class="text-center">
                ...
                <p class="mt-4 text-[#1e3c5c] font-medium">Loading profile...</p>
            </div>
        </div>

        <!-- dashboard content -->
        <div class="max-w-4xl mx-auto space-y-6" x-show="!loading &amp;&amp; !error">
                ...
                <div class="bg-white rounded-xl shadow-md border border-[#b5e5e0] p-4 card-hover">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-lg font-bold text-[#1e3c5c]" x-text="formatDate(profile.createdDate)"></p>
                        </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <div class="mt-1">
                                            <span class="role-badge" x-text="formatRole(profile.role || 'guest')"></span>
                                        </div>
                                    </div>
                                    <div>
            ...
            <div class="bg-white rounded-2xl shadow-md border border-[#b5e5e0] p-6">
                ...
                <div class="space-y-3">
                    <div class="flex items-center gap-3 text-sm">
                        ...
                        <span class="font-medium" x-text="formatDateTime(profile.createdDate) || 'Not available'"></span>
                    </div>
                    <div class="flex items-center gap-3 text-sm">
    ...
    <script>
        ...
        function profileManager() {
            return {
                ...
                // Load user data from server using userId from storage
                loadUserData: function() {
                    ...
                    debugLog('Loading profile for user ID:', userId);
                    
                    if (!userId) {
                        this.error = 'No user logged in. Please login again.';
                        this.loading = false;
                        setTimeout(() => {
                            window.location.href = this.baseUrl + '/login.jsp';
                        }, 2000);
                        return;
                    }
                    
                    // Construct the full URL with context path
                    const url = this.baseUrl + '/guests/api/' + userId;
                        ...
                        .then(response => {
                            ...
                            if (!response.ok) {
                                if (response.status === 404) {
                                    throw new Error('Profile API endpoint not found. Please check if the server is running.');
                                }
                ...
                checkUsernameAvailability: function() {
                    ...
                    const url = this.baseUrl + '/guests/api/username-exists?username=' + encodeURIComponent(this.profile.username) + '&excludeId=' + userId;
                ...
                checkEmailAvailability: function() {
                    ...
                    const userId = this.profile.id;
                    const url = this.baseUrl + '/guests/api/email-exists?email=' + encodeURIComponent(this.profile.email) + '&excludeId=' + userId;
                ...
                isFormValid: function() {
                    ...
                    return !hasErrors && usernameCheck && emailCheck;
                },
                ...
                saveProfile: function() {
                    ...
                    const url = this.baseUrl + '/guests/api/' + this.profile.id;
