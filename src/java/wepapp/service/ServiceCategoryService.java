...
interface ServiceCategoryValidationStrategy {
    boolean validate(ServiceCategory category);
    String getErrorMessage();
}

// Required Fields Validation Strategy
class ServiceCategoryRequiredFieldsStrategy implements ServiceCategoryValidationStrategy {
    @Override
    public boolean validate(ServiceCategory category) {
...
class ServiceCategoryNameLengthStrategy implements ServiceCategoryValidationStrategy {
...
class ServiceCategoryNameFormatStrategy implements ServiceCategoryValidationStrategy {
...
public class ServiceCategoryService {
    ...
    private final List<ServiceCategoryValidationStrategy> validators;
    
    public ServiceCategoryService() {
        this.categoryDAO = ServiceCategoryDAO.getInstance();
        this.validators = List.of(
            new ServiceCategoryRequiredFieldsStrategy(),
            new ServiceCategoryNameLengthStrategy(),
            new ServiceCategoryNameFormatStrategy()
        );
    }
    
    // Validate category using all strategies
    public ValidationResult validateCategory(ServiceCategory category) {
        for (ServiceCategoryValidationStrategy validator : validators) {
    ...
    // Create new category
    public ValidationResult createCategory(ServiceCategory category) {
        // Validate first
    ...
    // Update category
    public ValidationResult updateCategory(ServiceCategory category) {
    ...
    public List<ServiceCategory> getCategoriesByDateRange(LocalDate startDate, LocalDate endDate) {
        return categoryDAO.findByDateRange(startDate, endDate);
    }
    
    // Get categories by month and year
    public List<ServiceCategory> getCategoriesByMonthYear(int month, int year) {
        return categoryDAO.findByMonthYear(month, year);
    }
    
    // Get recent categories
    public List<ServiceCategory> getRecentCategories(int limit) {
    ...
    public boolean deleteCategory(int id) {
        ...
        // This would require a ServiceDAO check - implement as needed
